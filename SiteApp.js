...
), (function () { var aw = (window.getRecognition ? window.getRecognition("season_award").filter(function (a) { return a.season === (window.CURRENT_SEASON || "25/26"); }) : []); return aw.length ? h("section", { className: "mh-sec", style: { paddingTop: 0 } }, h("div", { className: "m-wrap" }, h(Head, { eyebrow: (window.CURRENT_SEASON || "25/26") + " End of Season", title: "Award winners" }), h("div", { className: "mp-grid mp-g4", style: { marginTop: 18 } }, aw.map(function (a) { var nm = a.playerName || (a.playerId && window.playerNameByNum ? window.playerNameByNum(a.playerId) : ""); return h("button", { key: a.id, className: "mh-pillar", onClick: function () { location.href = "awards.html"; } }, h("p", { className: "m-eyebrow m-eyebrow--volt" }, a.title), h("h3", { className: "m-h3" }, nm), h("span", { className: "mh-pillar__cta" }, "View →")); })), h("div", { style: { marginTop: 22, textAlign: "center" } }, h("a", { className: "m-btn m-btn--ghost", href: "awards.html" }, "All awards & honours →")))) : null; })(), /*#__PURE__*/React.createElement("section", {
    className: "mh-sec",
    id: "ledger"
  }, /*#__PURE__*/React.createElement("div", {
    className: "m-wrap"
