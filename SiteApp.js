...
function Home({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("section", {
    ...
    onClick: () => go('about')
  }, "Our story ", /*#__PURE__*/React.createElement(Arrow, null)))))), h("section", { className: "mh-sec" }, h("div", { className: "m-wrap" }, h(Head, { eyebrow: "Who we are", title: "More than a result" }), h("div", { className: "mp-grid mp-g4" }, [["Champions", "League Ten winners", "Played 18, won 18, unbeaten and promoted for 26/27.", "champions", "The season"], ["Community", "A football family", "Built in south-west London, playing for each other every week.", "about", "Our story"], ["Our cause", "Sepsis awareness", "Founded in memory of Susan Anne Martin. Know the signs.", "sepsis", "Our cause"], ["Partners", "Back the badge", "Local businesses on the shirt, and there is room for yours.", "sponsors", "Partner with us"]].map((p, i) => h("button", { key: i, className: "m-glass mp-clickable", onClick: () => go(p[3]), style: { textAlign: "left", padding: "clamp(20px,2.5vw,26px)", display: "flex", flexDirection: "column", gap: 8, cursor: "pointer" } }, h("p", { className: "m-eyebrow m-eyebrow--volt" }, p[0]), h("h3", { className: "m-h3" }, p[1]), h("p", { style: { color: "var(--m-ink-2)", flex: 1 } }, p[2]), h("span", { style: { color: "var(--m-volt-ink)", fontWeight: 600, fontSize: "0.8rem", display: "inline-flex", alignItems: "center", gap: 6, marginTop: 4 } }, p[4] + " →")))))), /*#__PURE__*/React.createElement("section", {
    className: "mh-sec",
    id: "ledger"
  }, /*#__PURE__*/React.createElement("div", {
    className: "m-wrap"
