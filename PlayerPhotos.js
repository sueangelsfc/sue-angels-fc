...
window.setPlayerPhoto = function (num, dataUrl) {
  try {
    ...
    window.dispatchEvent(new CustomEvent('sa-photo-changed', {
      detail: {
        num
      }
    }));
...
function PhotoUploader({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: `pup ${compact ? 'pup--compact' : ''}`
    ...
    d: "M14.7 6.3a1 1 0 0 1 0-1.4l1.4-1.4a1 1 0 0 1 1.4 0l2.6 2.6a1 1 0 0 1 0 1.4l-1.4 1.4a1 1 0 0 1-1.4 0Z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M14 8 4 18v3h3L17 11"
  })), /*#__PURE__*/React.createElement("span", null, photo ? 'Change photo' : 'Upload photo')), photo && /*#__PURE__*/React.createElement("button", {
    type: "button",
    className: "pup__btn pup__btn--danger",
    onClick: onClear
  }, "Remove"));
}
