...
const FORMS = [
  ...
  ['How long it is kept', 'An enquiry is deleted automatically two years after the club last heard from that email address, or sooner if you ask. A newsletter address is kept until you leave the list: use the link at the foot of any email and it is taken off MailerLite and the club’s own list automatically, or email the club and it will do the same.'],
