    ...
    h('section', { className: 'mp-sec', style: { paddingTop: 0 } }, h('div', { className: 'm-wrap' },
      h('div', { style: { position: 'relative', borderRadius: 'var(--m-radius)', overflow: 'hidden' } },
        h('picture', { style: { display: 'block', width: '100%' } },
          h('source', { type: 'image/webp', srcSet: 'assets/hero-team.webp' }),
          h('img', { src: 'assets/hero-team.jpg', alt: 'Sue’s Angels FC squad', loading: 'lazy', style: { width: '100%', aspectRatio: '16 / 7', objectFit: 'cover', objectPosition: '50% 28%', display: 'block' } })),
